...
{
    protected LLNode<T> collection;// reference to the front of this collection
    ...
    // Searches collection for an occurence of an element e such that
    ...
    // and returns true; if no such element exists, returns false.
    {
        ...
        if (found)
        {
            if (collection == location)
                collection = collection.getLink();    // remove first node
            else
