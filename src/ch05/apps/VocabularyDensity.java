...
public class VocabularyDensity
{
    public static void main(String[] args) throws IOException
    {
        ...
        SortedArrayCollection<String> sortedWords = new SortedArrayCollection<String>(CAPACITY);
        ...
        else
        {
            ...
            System.out.println("\n\tNumber of comparisons: " + words.compareCount());

            System.out.println("\tUnique words (Sorted): " + sortedWords.size());
            System.out.printf("\n\tVocabulary density (Sorted): %.2f", density);
            System.out.println("\n\tNumber of comparisons(Sorted): " + sortedWords.compareCount());
        }
    }
}